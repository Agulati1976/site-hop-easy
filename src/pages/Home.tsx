...
const hookah = { url: "/images/hookah-party.jpg" };
const belly = { url: "/images/belly-dance.jpg" };
const exotic = { url: "/images/exotic-dancers.jpg" };
const bellyShow = { url: "/images/belly-dance-show.jpg" };
const russianDancer = { url: "/images/russian-dancer.jpg" };
